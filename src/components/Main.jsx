        ...
        <>
            <main className='max-w-3xl m-auto w-full h-screen text-center flex justify-center items-center'>
                ...
                <div className='flex justify-center items-center flex-col gap-2'>
                    ...
                    Te quiero mucho pawil lo sabes??? </h1>
                    ...
                    <section className='flex gap-3'>
                        ...
                        <button className='bg-purple-500 w-28 text-white font-bold py-2 px-4 rounded transition-all hover:scale-110' onClick={handleButtonYes}> Si se </button>

                        <button className='bg-pink-500 w-20 text-white font-bold py-2 px-4 rounded transition-all hover:scale-110' onClick={handleButtonNo}> No, No lo se </button>
                    </section>
